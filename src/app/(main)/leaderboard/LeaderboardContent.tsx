          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-24 items-end">
            ...
            >
              ...
              <div className="flex flex-col items-center text-center relative z-10">
                ...
                <div className="text-xl font-bold font-heading text-neutral-300 mb-1">
                  {teams[1].name}
                </div>
            ...
            >
              ...
              <div className="flex flex-col items-center text-center relative z-10">
                ...
                <div className="text-6xl font-bold font-heading text-white mb-4">
                  01
                </div>
                <div className="text-2xl font-bold font-heading text-[#FFD700] mb-2">
                  {teams[0].name}
                </div>
                <div className="text-xs font-mono text-[#FFD700]/70 uppercase tracking-widest font-bold">
                  {teams[0].institute}
                </div>
            ...
            >
              ...
              <div className="flex flex-col items-center text-center relative z-10">
                ...
                <div className="text-xl font-bold font-heading text-amber-600 mb-1">
                  {teams[2].name}
                </div>
                <div className="text-[10px] font-mono text-neutral-500 uppercase tracking-widest">
                  {teams[2].institute}
          ...
          >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
              {[
                ...
                <div
                  key={stat.label}
                  className="p-4 border border-white/5 bg-[#05020a]/40 backdrop-blur-sm rounded-xl flex items-center justify-between group hover:border-white/10 transition-colors"
                >
                  <div>
                    <div className="text-[10px] uppercase tracking-widest text-neutral-500 font-bold mb-1">
                      {stat.label}
                    </div>
                    <div className="text-lg font-mono font-bold text-white group-hover:text-[#FFD700] transition-colors">
                      {stat.value}
                    </div>
                  </div>
            ...
            <div className="space-y-2">
              {teams.slice(3).map((team) => (
                ...
                >
                  <div className="col-span-2 md:col-span-1 font-mono text-neutral-400 group-hover:text-white">
                    #{team.rank.toString().padStart(2, "0")}
                  </div>
                  <div className="col-span-6 md:col-span-5">
                    <div className="font-heading font-bold text-white group-hover:text-[#FFD700] transition-colors text-lg">
                      {team.name}
                    </div>
                  ...
                  <div className="col-span-2 md:col-span-3 text-right md:text-left text-sm text-neutral-400 hidden md:block group-hover:text-neutral-200">
                    {team.institute}
                  </div>
                  <div className="col-span-4 md:col-span-3 text-right font-mono text-white font-bold group-hover:text-[#FFD700]">
